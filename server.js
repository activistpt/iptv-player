...
app.get('/api/m3u', async (req, res) => {
  ...
  try {
    // Detectar se é URL Xtream Codes (contém get.php ou player_api.php com username/password)
    const isXtream = m3uUrl.includes('get.php') || m3uUrl.includes('player_api.php');
